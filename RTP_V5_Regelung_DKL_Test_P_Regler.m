...
Tv = (Tz1*Tz2 - T*Tn) / Tn;   % Berechnungsformel eingeben, nicht Zahlenwert!
...
G_komp = tf(zkomp, nkomp);

Go = G_komp * G_s * Gr;           % offener Kreis mit Regler
%Go = G_s * Gr;
...
K = 0.0509;                         % Reglerverstärkung aus WOK, dominierende Pole auf Verzweigungspunkt
